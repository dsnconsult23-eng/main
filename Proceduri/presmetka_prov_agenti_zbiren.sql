CREATE FUNCTION vesna.presmetka_prov_agenti_zbiren(tmesec char(2) , tgodina char(4) ,tuser_id int )
...
join polisa_max pm on pm.polisa_broj_cel = p.polisa_broj_cel
                  and pm.max_pod_broj    = p.polisa_pod_broj
where o.skadenca_datum_od >= DATE(EXTEND(ADD_MONTHS(TODAY, -48), YEAR TO MONTH))
group by 1, 2, 3
